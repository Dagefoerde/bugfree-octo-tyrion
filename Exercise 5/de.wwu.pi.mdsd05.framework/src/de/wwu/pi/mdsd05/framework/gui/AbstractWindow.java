...
public abstract class AbstractWindow {
	...
	public AbstractWindow(AbstractWindow parent,int width,int height) {
		super();
		this.parent = parent;
		this.width=width;
		this.height=height;
	...
	/**
	 * Own container class that is subclass of Container and enhances add method to wrap certain elements with e.g. a JScrollPane.
	 * @author cl-a.us
	 *
	 */
